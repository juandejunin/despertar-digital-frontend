...
//   // Lógica para el color del contador
//   const messageLength = form.message.length;
//   const remaining = 500 - messageLength;

//   let counterColor = "text-gray-500"; // por defecto gris
//   if (remaining <= 50) {
...
//       <p class={`text-sm text-right font-medium ${counterColor} transition-colors duration-200`}>
//         {messageLength} / 500
//       </p>
